...
import com.unnamedworld.command.CommandAutoRestart;
import com.unnamedworld.command.CommandChunkLoad;
import com.unnamedworld.command.CommandEndPortal;
import com.unnamedworld.command.CommandEntities;
import com.unnamedworld.command.CommandFlowers;
...
import com.unnamedworld.command.CommandUnmute;
...
import com.unnamedworld.command.CommandPregen;
import com.unnamedworld.command.CommandReport;
import com.unnamedworld.command.CommandHealth;
import com.unnamedworld.command.CommandLoreItem;
import com.unnamedworld.command.CommandReports;
import com.unnamedworld.command.CommandSize;
import com.unnamedworld.command.CommandTempban;
import com.unnamedworld.command.CommandTown;
import com.unnamedworld.command.CommandVanish;
import com.unnamedworld.command.CommandWhitelist;
...
public class ServerMod {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        SizeManager.INSTANCE.init(configDir);
        LoreCosmeticManager.INSTANCE.init(configDir);
        ...
        MinecraftForge.EVENT_BUS.register(SizeManager.INSTANCE);
        MinecraftForge.EVENT_BUS.register(LoreCosmeticManager.INSTANCE);
    ...
    public void serverStarting(FMLServerStartingEvent event) {
        ...
        event.registerServerCommand(new CommandLoreItem());
        ...
        event.registerServerCommand(new CommandMuteList());
